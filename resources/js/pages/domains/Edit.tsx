    ...
    return (
        ...
        >
            <DialogHeader>
                ...
                <DialogDescription>Update domain information and privilege settings.</DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Domain Preview */}
                <div className="rounded-lg border bg-gray-50 p-4" role="region" aria-label="Current Domain Settings">
                    <h4 className="mb-2 text-sm font-medium text-gray-900">Current Settings</h4>
                    <div className="space-y-3 text-sm">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {selectedPrivilege ? (
                                ...
                                <span className="font-medium">{data.privilege}</span>
                            )}
                        </div>
                    </div>
                </div>
                        ...
                        {domain.privilege !== data.privilege && (
                            <div className="mt-2 border-t border-gray-200 pt-2">
                                <p className="text-xs text-gray-500" role="status">
                                    Changed from: <span className="font-medium capitalize">{domain.privilege}</span>
                                </p>
                            </div>
                        )}
                    </div>
